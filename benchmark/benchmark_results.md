...
### Per-File Structure Scores

| File | Tool | HeaderScore | ListScore | TableScore | ImageScore | MarkdownStructureScore |
| :--- | :---: | ---: | ---: | ---: | ---: | ---: |
| `2025930046 청량리역 롯데캐슬 SKY-L65 불법행위 재공급 입주자모집공고문` | `2md` | 0.000 | 0.112 | 1.000 | 0.000 | 0.278 |
|  | `markitdown` | 0.000 | 0.112 | 0.000 | 0.000 | 0.028 |
| `The-Complete-Guide-to-Building-Skill-for-Claude` | `2md` | 0.184 | 0.429 | 0.067 | 1.000 | 0.420 |
|  | `markitdown` | 0.184 | 0.422 | 0.000 | 1.000 | 0.402 |
| `Agentic_Design_Patterns` | `2md` | 0.096 | 0.424 | 0.039 | 0.138 | 0.174 |
|  | `markitdown` | 0.069 | 0.416 | 0.000 | 0.000 | 0.121 |
| `Soonmo_Seong_CV_20260206` | `2md` | 0.000 | 0.000 | 0.000 | 1.000 | 0.250 |
|  | `markitdown` | 0.000 | 1.000 | 0.000 | 1.000 | 0.500 |
| `[SHARE] 202601XX_Press Release_Data Superhero_draft (1)` | `2md` | 0.028 | 0.600 | 0.118 | 1.000 | 0.436 |
|  | `markitdown` | 0.000 | 1.000 | 0.000 | 1.000 | 0.500 |

### Structure Count Reference

| File | PDF Headers | PDF Lists | PDF Tables | PDF Images | 2md Headers | 2md Lists | 2md Tables | 2md Images | MarkItDown Headers | MarkItDown Lists | MarkItDown Tables | MarkItDown Images |
| :--- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| `2025930046 청량리역 롯데캐슬 SKY-L65 불법행위 재공급 입주자모집공고문` | 2 | 19 | 12 | 3 | 0 | 170 | 12 | 0 | 0 | 169 | 0 | 0 |
| `The-Complete-Guide-to-Building-Skill-for-Claude` | 87 | 289 | 1 | 0 | 16 | 124 | 15 | 0 | 16 | 122 | 0 | 0 |
| `Agentic_Design_Patterns` | 5479 | 191 | 2051 | 65 | 525 | 451 | 79 | 9 | 380 | 459 | 0 | 0 |
| `Soonmo_Seong_CV_20260206` | 33 | 0 | 14 | 0 | 0 | 2 | 0 | 0 | 0 | 0 | 0 | 0 |
| `[SHARE] 202601XX_Press Release_Data Superhero_draft (1)` | 36 | 3 | 17 | 0 | 1 | 5 | 2 | 0 | 0 | 3 | 0 | 0 |
